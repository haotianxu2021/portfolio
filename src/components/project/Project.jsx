            ...
            <Sheet variant='soft' color='neutral' sx={{ my: 0 }}>
                <Sheet variant="soft" sx={{
                    ...
                    <Box sx={{
                        ...
                        <Card variant="outlined" sx={{ maxWidth: {lg:'28%', md:'40%', xs:'100%'}, ml: 'auto', mr: 'auto' }}>
                            <CardOverflow>
                                <AspectRatio ratio="2">
                                    <img
                                        src={img1}
                        ...
                        <Card variant="outlined" sx={{ maxWidth: {lg:'28%', md:'40%', xs:'100%'}, ml: 'auto', mr: 'auto', visibility:'hidden' }}>
